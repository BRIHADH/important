...
const char mySSID[] = "Somu";
const char myPSK[] = "9912744742";
//////////////////////////////
...
//////////////////
int distance;
const char destServer[] = "18.214.44.70";
const String htmlHeader = "HTTP/1.1 200 OK\r\n"
                          "Content-Type: text/html\r\n"
                          "Connection: close\r\n\r\n"
                          "<!DOCTYPE HTML>\r\n"
                          "<html>\r\n";
const String httpRequest1 = "GET /update?api_key=UF298F8QPWZCH6IB&field1=";
...
void clientDemo()
{
  ...
  ultraRead();
    ...
    delay(1000);
  client.print(httpRequest1+distance+httpRequest2);
  

  // available() will return the number of c0haracters
